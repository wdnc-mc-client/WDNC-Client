...
import com.client.wdnc.Menu.onGuiOpenEvent;
import com.client.wdnc.UI.ui;
import com.client.wdnc.keys.key;
...
{
    public static final String MODID = "wdnc";
    public static final String NAME = "WDNC Hack Client";
    ...
    public static void setSession(Session s) {
        ...
        try {
            ...
            Client.name = "wdnc 1.12.2 | User: " + Minecraft.getMinecraft().getSession().getUsername();
